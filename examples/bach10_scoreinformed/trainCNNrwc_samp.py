...
def build_ca_old(input_var=None, batch_size=32,time_context=30,feat_size=513,nchannels=4):
    """
...
if __name__ == "__main__":
    ...
    # ld1 = LargeDatasetMask2(path_transform_in=path_in, nsources=4, batch_size=batch_size, batch_memory=batch_memory, time_context=time_context, overlap=overlap, nprocs=nprocs,mult_factor_in=scale_factor,mult_factor_out=scale_factor,\
    ...
    train_errs=train_auto(fun=funcs[function],transform=tt,outdir=os.path.join(output,'output',model),testdir=db,testfile_list=testfile_list,\
        ...
        path_transform_in=path_in,nsamples=nsamples,batch_size=batch_size, batch_memory=batch_memory, time_context=time_context, overlap=overlap,
        nprocs=nprocs,mult_factor_in=scale_factor,mult_factor_out=scale_factor,timbre_model_path=timbre_model_path)
