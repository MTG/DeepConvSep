...
if __name__ == "__main__": 
    ...
    ld1 = LargeDataset(path_transform_in=dirtt, batch_size=batch_size, batch_memory=batch_memory, time_context=time_context, overlap=overlap, nprocs=nprocs,mult_factor_in=scale_factor,mult_factor_out=scale_factor)
