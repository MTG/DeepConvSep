...
opdir='/home/pritish/pc_bss/datasets/MSD100/Data5/FFT/d'
...
for x in subdirectories:
    ...
    #/home/pritish/pc_bss/nueralnts/neuralnets/rwc_cello
            ...
            # others1=[]
            # mix=[]
            # for i in range(len(mix_raw)/441):
            #     if abs(mix_raw[441*i:441*(i+1)]).mean()>0.02:
            ...
            last_block=len(mix_raw)%(44100*30)              
            print "starting"        
