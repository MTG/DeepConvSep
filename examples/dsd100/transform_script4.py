...
for x in subdirectories:
	...
	#/home/pritish/pc_bss/nueralnets/neuralnets/rwc_cello
			...
			last_block=len(target1)%(44100*30)				
			print "starting"		
			for i in range(number_of_blocks):
				...
				megatron.compute_transform(b,directory+'/Data4/FFT/Dev/'+typeofmix+'/'+x+'_'+str(i)+'.data',phase=False)
			...
			megatron.compute_transform(b,directory+'/Data4/FFT/Dev/'+typeofmix+'/'+x+'_'+str(i+1)+'.data',phase=False)
